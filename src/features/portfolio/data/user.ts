...
export const USER: User = {
  ...
  about: [
    "ProfessionalGame developer since **2020** with a strong passion for the technical side of game development. I enjoy exploring new features, technologies, and game engines.",
